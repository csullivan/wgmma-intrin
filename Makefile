...
# Targets
TARGETS = test_single_instance_wgmma test_layout_transform_general test_wgmma_from_regs
...
# Rule for test_wgmma
test_single_instance_wgmma: test_single_instance_wgmma.cu $(WGMMA_HEADER) $(TRANSFORM_HEADER)
